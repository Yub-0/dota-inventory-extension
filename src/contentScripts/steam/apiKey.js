            ...
            document.getElementById('editForm').insertAdjacentHTML(
              ...
              DOMPurify.sanitize(
                `<div class="apiKeyAdded" ">
                        Added API key to DOTA Extension, if you don't like this happening you can go the options and turn Autoset off.
                    </div>`,
              ),
            );
          });
          ...
          document.getElementById('editForm').insertAdjacentHTML(
            ...
            DOMPurify.sanitize(
              `<div style="color:red; margin-top: 10px;">
                    DOTA Extension could not validate your API key, please try again.
                  </div>`,
            ),
          );
